...
# Impplement Logic of BFS, here.
def bfs(start):
    queue = [start]
    levels = {}  # This Dict keeps track of levels.
    # But, what levels it keeps track of?
    levels[start] = 0  # Depth of start node is 0.
    visited = set(start)
    while queue:
        node = queue.pop(0)  # FIFO
        neighbours = input_graph[node]
...
def shortest_path(graph, start, goal):
    try:
        ...
        return None
result1 = shortest_path(input_graph, 'A', 'F')
print(result1) # ['A', 'C', 'F']
