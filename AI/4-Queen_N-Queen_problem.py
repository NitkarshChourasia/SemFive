...
def solve_queen(size):
    ...
    if column == size or row == size:
        ...
        if row == size:
            ...
            # the last row where a queen can be placed. In this case, there is a valid position in the last row.
            # Thus we can backtrack two times to reach the second last row.
